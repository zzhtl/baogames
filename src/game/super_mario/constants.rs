...
pub const FLOOR_Y: f32 = -ARENA_H * 0.5 + TILE * 0.5 + 8.0;

pub const PLAYER_W: f32 = 22.0;
pub const PLAYER_H: f32 = 28.0;
pub const BIG_PLAYER_H: f32 = 48.0;
...
pub const GOOMBA_W: f32 = 26.0;
pub const GOOMBA_H: f32 = 26.0;
pub const GOOMBA_SPEED: f32 = 55.0;
pub const GOOMBA_SQUASH_TIME: f32 = 0.45;

pub const POWERUP_SIZE: f32 = 26.0;
...
pub const SHARD_SIZE: f32 = 10.0;
pub const SHARD_LIFE: f32 = 1.0;

pub const KOOPA_W: f32 = 26.0;
pub const KOOPA_H: f32 = 38.0;
pub const KOOPA_SPEED: f32 = 50.0;
pub const SHELL_SPEED: f32 = 360.0;
pub const SHELL_W: f32 = 26.0;
pub const SHELL_H: f32 = 24.0;

pub const PLATFORM_W: f32 = 84.0;
pub const PLATFORM_H: f32 = 12.0;
pub const PLATFORM_SPEED: f32 = 80.0;
pub const PLATFORM_RANGE: f32 = 120.0;

pub const BOWSER_W: f32 = 56.0;
pub const BOWSER_H: f32 = 60.0;
