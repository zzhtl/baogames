...
pub(super) use resources::{MarioControls, MarioStage};
...
pub(super) use systems::{
    ...
    mario_bowser_fireball_update, mario_camera_follow, mario_coin_popup,
    ...
    mario_player_animation, mario_player_blink, mario_player_fire_vs_bowser, mario_player_input,
    mario_player_vs_goomba,
    mario_checkpoint_update, mario_player_vs_koopa, mario_player_vs_powerup,
    mario_powerup_update, mario_respawn, mario_sample_input,
